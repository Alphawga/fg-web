...
export default function MobileSideNavBar () {
  ...
  const updateOpenSideNav = useMobileSideNavBarStore((state) => state.setOpenSideNav);

  return (
    <div className="absolute z-10 top-0 left-0 h-screen w-[90%] bg-[#231f20] animate-accordion-left text-white pl-5 pr-14 pt-32">
      <nav>
